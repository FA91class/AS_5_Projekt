...
## Report bugs using Github's [issues](https://github.com/FA91class/AS_5_Projekt/issues)
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/FA91class/AS_5_Projekt/issues/new/choose); it's that easy!

## Write bug reports with detail, background, and sample code
Therefore use the Bug Template.
